...
- `sunny-sky-background.png`: nicht zerstörbarer Himmel und entfernte Landschaft
- `good-mood-terrain.png`: freigestelltes, vollständig zerstörbares Vordergrundterrain
...
Die Assets wurden mit Built-in Imagegen erzeugt. Das Terrain wurde auf grünem Chroma-Key generiert und anschließend mit Soft-Matte und Despill freigestellt. Die vollständigen Prompts stehen in `docs/ASSET_GENERATION.md`.
